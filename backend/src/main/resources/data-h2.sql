...
INSERT INTO account (username, first_name, last_name, password, email, is_active) VALUES ('Obieżyświat', 'Aragorn', 'Elessar', '$2y$12$3fd99QFLRdLLDJyKB3OtGe2T6paUS66hePAzMEUWAX4yyyJxOAT/S','aragorn@o2.pl',true);
...
INSERT INTO post (lob, description, add_date,account_id) VALUES (FILE_READ('classpath:images/aragorn_weed.jpg'),'Się jara dzieciaku he he...',{ts '2013-12-17 18:47:52.69'},5);
